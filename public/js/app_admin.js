...
var confirmareliminar = new Vue({
  ...
  methods: {
    deseas_eliminar: function deseas_eliminar(id) {
      this.url_eliminar = "".concat(document.getElementById('ruta').innerHTML, "/").concat(id);
    }
  }
});
...
module.exports = __webpack_require__(/*! D:\2022\laravel6\l7-shop\resources\js\app_admin.js */"./resources/js/app_admin.js");
